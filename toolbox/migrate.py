...
def main():
    ...
    if not new:
        ...
        if create == "Y":
            ...
            print(
                "I will now create the database schema and tables if they do not exist."  # noqa: E501 # pylint: disable=line-too-long
            )
        ...
        print(
            "If you would like to create a new config file, please delete the existing one."  # noqa: E501 # pylint: disable=line-too-long
        )
        print(
            "I will now create the database schema and tables if they do not exist."  # noqa: E501 # pylint: disable=line-too-long
        )
