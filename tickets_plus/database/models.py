...
class Guild(Base):
    ...
    any_autoclose: orm.Mapped[int | None] = orm.mapped_column(
        nullable=True, comment="Number of minutes since last response to autoclose"
    )
    support_block: orm.Mapped[int | None] = orm.mapped_column(
        sqlalchemy.BigInteger(),
        nullable=True,
        comment=(
            "Role to apply to users who are blocked from creating tickets"
...
class TicketBot(Base):
    ...
    guild: orm.Mapped["Guild"] = orm.relationship(
        back_populates="ticket_bots", lazy="selectin"
    )
...
class TicketType(Base):
    ...
    ignore: orm.Mapped[bool] = orm.mapped_column(
        default=False, nullable=False, comment="Whether to ignore this ticket type"
    )

    # Relationships
    guild: orm.Mapped["Guild"] = orm.relationship(
        back_populates="ticket_types", lazy="selectin"
    )
...
class Tag(Base):
    ...
    description: orm.Mapped[str] = orm.mapped_column(
        sqlalchemy.String(4096), nullable=False, comment="The description of the embed"
    )
    url: orm.Mapped[str] = orm.mapped_column(
        sqlalchemy.String(256), nullable=True, comment="The url of the embed"
    )
    color: orm.Mapped[int] = orm.mapped_column(
        sqlalchemy.Integer(), nullable=True, comment="The color of the embed"
    )
    footer: orm.Mapped[str] = orm.mapped_column(
        sqlalchemy.String(2048), nullable=True, comment="The footer of the embed"
    )
    image: orm.Mapped[str] = orm.mapped_column(
        sqlalchemy.String(256), nullable=True, comment="The image of the embed"
    )
    thumbnail: orm.Mapped[str] = orm.mapped_column(
        sqlalchemy.String(256), nullable=True, comment="The thumbnail of the embed"
    )
    author: orm.Mapped[str] = orm.mapped_column(
        sqlalchemy.String(256), nullable=True, comment="The author of the embed"
    )
...
class StaffRole(Base):
    ...
    __table_args__ = {
        "comment": (
            "Roles that are allowed to view ticket notes,"
    ...
    role_id: orm.Mapped[int] = orm.mapped_column(
        ...
        primary_key=True,
        comment=(
            "Unique discord-provided role ID,"
    ...
    # Relationships
    guild: orm.Mapped["Guild"] = orm.relationship(
        back_populates="staff_roles", lazy="selectin"
    )
...
class Member(Base):
    ...
    status: orm.Mapped[int] = orm.mapped_column(
        ...
        default=0,
        comment=(
            "The status of the member, 0 is normal, "
